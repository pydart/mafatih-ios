...
urls=["https://www.erfan.ir/farsi/mafatih/index/4#firstpage"]
bab=0
...
for url in urls:
    ...
    for itr in range(0,len(data)):
        ...
        if itr == 0:
            dicNext=data[itr+1]
            dic['indexNext']=dicNext['index']
            dic['titleNext']=dicNext['title']
            dic['indentNext']=dicNext['indent']
            dic['indexPrev'] =''
            dic['titlePrev'] =''
            dic['indentPrev']=''
            ...
            dicPrev=data[itr-1]
            dic['indexPrev'] =dicPrev['index']
            dic['titlePrev'] =dicPrev['title']
            dic['indentPrev']=dicPrev['indent']
            dic['indexNext']=''
            dic['titleNext']=''
            dic['indentNext']=''

        elif itr!= len(data)-1 | itr!=0  :
            dicNext=data[itr+1]
            dicPrev=data[itr-1]
    ...
    dirDestination="G:\\Flutter\\Qurani2 -Babs - Copy - Copy\\python\\BabsPrevNext"
    dirDestination="G:\Python\AppsWithHj\Mafatih"
    ...
    with open(dirFinal, "w", encoding='utf8') as write_file:
        json.dump(dataNew, write_file, ensure_ascii=False, indent=4)
    # break
