...
class Activity_SetNewForgetPassword extends StatefulWidget
{

  @override
  State<StatefulWidget> createState() =>Activity_SetNewForgetPassword_State();

}

class Activity_SetNewForgetPassword_State extends State<Activity_SetNewForgetPassword>
{
                  ...
                  child: Container(
                    ...
                    child: TextButton(
                      style: TextButton.styleFrom(
                          backgroundColor:(check_password && check_repassword && password_text.text==repassword_text.text)?Colors.blue: Colors.grey,
                      ...
                      onPressed: () async {
                        ...
                        if(check_password && check_repassword)
                        {
                          if(password_text.text==repassword_text.text)
                          {
                            ...
                            api().OverwiteNewPasswordForgetPassword(Phone_Number, forgetpass_code_catch, repassword1, repassword2).then((value) {
