...
class DetailSec4 extends StatefulWidget {
  ...
  @override
  _DetailSec4State createState() => _DetailSec4State();
}
  ...
  void _downloadButtonPressed() async {
    ...
    if (isOnline == true) {
      ...
      print(
          ";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; ${widget.code}");
      String audioUrl =
          'https://www.videoir.com/apps_versions/audios/${widget.code}.mp3';
      ...
      response.stream.listen(
        (List<int> newBytes) {
          ...
          setState(() {
            ...
            status =
                "   در حال دانلود ${((progress ?? 0) * 100).toStringAsFixed(2)} % ";
          });
  ...
  Widget build(BuildContext context) {
    ...
    ui.edameFarazSet == true
        ? WidgetsBinding.instance.addPostFrameCallback((_) {
            _scrollToPixel();
            ui.edameFarazSet = false;
          })
        : null;
    bool audioIsSaved =
        File("data/user/0/pydart.mafatih/cache/${widget.code}.mp3")
            .existsSync();
    print(
        "-----------------------------------------------------------------  audioIsSaved   ----------- $audioIsSaved");
